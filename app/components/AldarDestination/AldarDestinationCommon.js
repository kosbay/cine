...
const AldarDestinationButtonWrapper = styled.div`
  opacity: 1;
`;

const AldarDestinationButton = styled.button`
...
const AldarDestinationButtonText = styled.p`
  width: 80%;
  margin: 0;
`;
...
const AldarTalkWrapper = styled.div`
  flex: 1;
`;
