...
class CodeEqualityContainer extends React.PureComponent {
  ...
  handleCodeCompileSuccess = ({ code }) => {
    const { lesson, makeNextButtonActive: makeNextButtonActiveFunc, t } = this.props;
    if (ValidationUtils.isStringContentEqual(code, lesson.solutionCode)) {
